...
try {
    ...
    $stmt_cat = $conn->prepare("SELECT id FROM categories WHERE name = 'Cruise' LIMIT 1");
    $stmt_cat->execute();
    $categoryId = $stmt_cat->fetchColumn();
    if (!$categoryId) { throw new Exception("Cruise category not found."); }

    // Get filter data from the database
    ...
    // Process any filters the user submitted
    ...
    // Build the query to get all tours, applying filters if they exist
...
<main>
    ...
    <div class="container">
        <section class="hero-search-bar">
            <form action="<?php echo $baseURL; ?>/cruise/" method="GET" class="row g-3 align-items-center">
        ...
        <div class="container">
            ...
            <?php else: ?>
                <div class="row">
                    ...
                    <?php $t['slug'] = create_slug($t['title']); // Create the clean URL part ?>
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex align-items-center mt-auto pt-3">
                                        <!-- The link now points to the clean URL -->
...
<?php 
// This includes the footer and the universal inquiry modal
