...
<main>
    ...
    <?php elseif ($tour): ?>
        ...
        <section class="page-banner" style="background-image: url('<?php echo $baseURL; ?>/uploads/tours/<?php echo $tour['image']; ?>');">
             <div class="slide-overlay"><div class="hero-content"><h1 class="hero-title"><?php echo htmlspecialchars($tour['title']); ?></h1></div></div>
        </section>
